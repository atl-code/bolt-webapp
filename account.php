            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">State</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  echo '<input type="text" id="right-label" placeholder="'. $obj->state. '" name="state">';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Country</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
